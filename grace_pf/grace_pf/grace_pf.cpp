// grace_pf.cpp : Defines the initialization routines for the DLL.
//
...
BEGIN_MESSAGE_MAP(CgracepfApp, CWinApp)
END_MESSAGE_MAP()


// CgracepfApp construction

CgracepfApp::CgracepfApp()
{
...
// The one and only CgracepfApp object

CgracepfApp theApp;


// CgracepfApp initialization

BOOL CgracepfApp::InitInstance()
{
